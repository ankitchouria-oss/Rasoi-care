...
/// Shown once, right after a staff/owner's first successful sign-in —
...
class BiometricEnrollScreen extends ConsumerStatefulWidget {
  const BiometricEnrollScreen({this.nextRoute = '/dashboard', super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                'Admin with your fingerprint or face instead of signing in every time.',
...
class _BiometricLockScreenState extends ConsumerState<BiometricLockScreen> {
  ...
  Future<void> _unlock() async {
    ...
    final ok = await ref
        .read(biometricServiceProvider)
        .authenticate('Verify it\'s you to open Rasoi Care Admin');
    if (!mounted) return;
    if (ok) {
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('Rasoi Care Admin', style: CareType.display(CareColors.porcelain, size: 24)),
