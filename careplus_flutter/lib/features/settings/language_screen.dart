// Real language picker — switching here actually re-renders every wired
// screen's UI chrome in the chosen language via AppLocalizations (see
// lib/l10n/). Server/user data (a customer's name, an address someone
// typed) is never machine-translated; only this app's own labels, buttons
// and messages change.
              ...
              child: Column(
                children: [
                  ...
                  _langRow(context, ref,
                      ...
                      selected: current.languageCode == 'mr',
                      last: true),
                ],
              ),
            ),
