...
/// once right after sign-up and toggleable in Account > Preferences.
/// Defaults to off until the real stored value (if any) loads.
...
/// whether Account > Preferences even shows the biometric login row.
